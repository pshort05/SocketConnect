...
#define	SERV_PORT		 31001			/* TCP and UDP */
#define	SERV_PORT_STR	"31001"			/* TCP and UDP */
...
void sys_err( char * szError )
{
	printf( "%s\n", szError );
}

void err_sys( char * szError )
{
	printf( "%s\n", szError );
}

void err_quit( char * szError )
{
	printf( "%s\n", szError );
	exit(-1);
}
